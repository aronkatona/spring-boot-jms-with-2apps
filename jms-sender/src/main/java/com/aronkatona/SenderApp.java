...
public class SenderApp {
    ...
    @JmsListener(destination = SENDER_QUEUE_NAME, containerFactory = "myJmsContainerFactory")
    public void receiveStringDestinationA(String message) {
        System.out.println("message from " + SENDER_QUEUE_NAME + ": <" + message + ">");
	...
	private void sendBackMessage(String message) {
		 ...
		 System.out.println("Sending back message to: " + RECEIVER_QUEUE_NAME);
		 jmsTemplate.convertAndSend(RECEIVER_QUEUE_NAME, message);
	}
